...
def fire_bullet(ai_settings, screen, ship, bullets, move):
    laser_sound = pygame.mixer.Sound(resource_path("resourses/shot.wav"))
...
def check_bullet_alien_collisions(ai_settings, screen, stats, ship, aliens, bullets, bonuses):
    explosion_sound = pygame.mixer.Sound(resource_path("resourses/explosion.wav"))
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
    ...
    life_lost_sound = pygame.mixer.Sound(resource_path("resourses/life_lost.wav"))
    game_over_sound = pygame.mixer.Sound(resource_path("resourses/game_over.wav"))
