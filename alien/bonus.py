...
class Bonus(pygame.sprite.Sprite):
    ...
    def __init__(self, ai_settings, screen, bonus_type, x, y):
        ...
        if bonus_type == 'life':
            self.image = pygame.image.load(gf.resource_path('resources/life.bmp'))  # Бонус жизни
        elif bonus_type == 'shield':
            self.image = pygame.image.load(gf.resource_path('resources/shield.bmp'))  # Бонус щита
